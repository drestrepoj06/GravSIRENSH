...
class LinearEquivalentGenerator:
    ...
    def __init__(self, run_dir, data_path, altitude=0.0):
        ...
        # -------------------------------
        # Load config and get model lmax
        # -------------------------------
    ...
    def generate_linear_equiv(self, L):
        ...
        return df, clm_full_g, clm_low_g, r0

    def evaluate_on_test(self, df_grid, clm_full_g, clm_low_g, r0, L, save=True, label=""):
        """
        Evaluate linear gravity field on the test grid at spherical-harmonic degree L.
        """
